...
class Cache(object):
    """An abstract class - provides cache directories for data from links
        ...
        :param allowed_formats: which formats of files the cache should store_app.
    ...
    def get_path_for_link(self, link):
        # type: (Link) -> str
        """Return a directory to store_app cached items in for link.
        """
        raise NotImplementedError()
...
class SimpleWheelCache(Cache):
    ...
    def get_path_for_link(self, link):
        # type: (Link) -> str
        """Return a directory to store_app cached wheels for link
