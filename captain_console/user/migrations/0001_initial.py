    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(default='', help_text='Enter first name', max_length=32)),
                ('last_name', models.CharField(default='', help_text='Enter last name', max_length=32)),
                ('image', models.CharField(default='static/images/base_cover.png', max_length=999)),
